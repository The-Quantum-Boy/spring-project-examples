...
import com.sumit.repository.MessageModelRepo;
...
import com.sumit.repository.FoOrdersRepo;
...
//	private ProductRepository productRepository;
	...
	@Autowired
	private MessageModelRepo messageModelRepo;
	
	@Autowired
	private FoOrdersRepo foOrdersRepo;
//	
	...
	public void run(String... args) throws Exception {
		...
		model.setAuctionOrdNo("sumit");

		messageModelRepo.save(model);
	}
...
//
//
//		FoOrders order=FoOrders.builder()
//				.exchOrdNo("sam")
//				.intrOrdNo("1118180472328560640")
//				.build();
//
//		foOrdersRepo.save(order);
//
//	}
